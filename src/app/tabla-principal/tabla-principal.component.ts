...
export class TablaPrincipalComponent implements OnInit{
  ...
  let urlFormularioPrincipal = 'http://3.142.255.242/formularioPrincipal';
  ...
  enviarCorreo(participante: Participante) {
    let mensaje = '';
    let urlFormularioPago = `http://3.142.255.242/formularioPago/${participante.codigo_participante}`;
